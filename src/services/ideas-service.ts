...
const DRAWDOWN_ATTRIBUTION_RULES: AttributionMacroRule[] = [
    {
        ...
        reason_zh: 'ATT削弱广告定向、TikTok分流时长、元宇宙投入激增 → Meta广告转化率与利润率下滑 → 广告收入与EPS预期被下修',
    ...
    },
    {
        ...
        reason_zh: 'Adobe收购Figma告吹、AI设计工具分流需求 → Creative Cloud新增席位与提价能力走弱 → 营收增速和创意软件估值被下修',
        family: 'software-saas-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['ADBE'],
    ...
    },
    {
        ...
        reason_zh: 'Mounjaro/Zepbound放量推高GLP-1竞争预期 → 产能、定价与口服竞品节奏反复波动 → LLY减肥药收入与估值溢价被重定价',
    ...
    },
    {
        ...
        reason_zh: '对越南与中国制造加征关税 → NKE/LULU采购成本抬升、中国份额被本土品牌分流 → 毛利率与收入预期被下修',
    ...
    },
    {
        ...
        reason_zh: 'Nike DTC收缩、批发渠道修复偏慢 → 北美同店走弱、折扣率抬升与库存偏高 → 营收增速和EPS修复预期被下调',
        family: 'consumer-discretionary-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['NKE'],
    ...
    },
    {
        ...
        reason_zh: 'Lululemon产品创新偏弱、款式决策失误 → 美国同店放缓、库存与折扣压力上升 → 收入增速和利润率预期被重置',
        family: 'consumer-discretionary-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['LULU'],
    ...
    },
    {
        ...
        reason_zh: '加息抬升融资成本并冻结IPO并购 → 承销顾问费下滑、Marcus减值扩大亏损 → 高盛投行收入与ROE预期被下修',
    ...
    },
    {
        ...
        reason_zh: '高利率推高信用卡滚动余额与坏账压力 → 准备金计提上升、旅行消费增速放缓 → AXP净利润与ROE预期被下修',
        family: 'banking-credit-cycle',
        driver_type: 'macro',
        applies_to: 'symbols_only',
        symbols: ['AXP'],
    ...
    },
    {
        ...
        reason_zh: 'PC与消费电子需求转弱 → 渠道库存攀升、ASP与出货同步下滑 → AMD/INTC收入与盈利预期被下修',
    ...
    },
    {
        ...
        reason_zh: '挖矿退潮叠加PC需求转弱 → RTX库存攀升、游戏GPU均价下滑 → NVIDIA营收增速与估值溢价被重置',
        family: 'semiconductor-downcycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['NVDA'],
    ...
    },
    {
        ...
        reason_zh: 'DRAM/NAND供给过剩加剧 → 合约价与出货节奏同步下滑、库存天数攀升 → MU盈利与现金流预期被下修',
    ...
    },
    {
        ...
        reason_zh: '美国禁止A100/H100对华销售 → 中国数据中心订单递延、产品组合恶化 → NVIDIA中国收入与利润预期被下修',
    ...
    },
    {
        ...
        reason_zh: '美国将H800/A800纳入限制 → 中国替代订单受阻、出货节奏放缓 → NVIDIA中国营收与估值溢价被压缩',
        family: 'chip-export-control',
        driver_type: 'policy',
        applies_to: 'symbols_only',
        symbols: ['NVDA', 'AMD'],
    ...
    },
    {
        ...
        reason_zh: 'BIS扩大实体清单与设备限制 → 对华出货与高毛利服务收入放缓 → 美系半导体中国业务预期与估值倍数被下修',
        family: 'chip-export-control',
        driver_type: 'policy',
        applies_to: 'symbols_only',
    ...
    },
    {
        ...
        reason_zh: '美国扩大先进芯片与设备对华禁令 → 对华订单、装机与供应链节奏放缓 → 半导体龙头收入预期与估值倍数被压缩',
        family: 'chip-export-control',
        driver_type: 'policy',
        applies_to: 'symbols_only',
    ...
    },
    {
        ...
        reason_zh: '中国出货条件性恢复并附带营收分成 → H200/MI325X有限放量、合规成本抬升 → NVDA/AMD中国利润率与估值弹性被重估',
        family: 'chip-export-control',
        driver_type: 'policy',
        applies_to: 'symbols_only',
        symbols: ['NVDA', 'AMD'],
    ...
    },
    {
        ...
        reason_zh: '存储厂下调晶圆厂资本开支 → WFE订单递延、设备交付与利用率走弱 → AMAT/LRCX收入与利润率预期被下修',
    ...
    },
    {
        ...
        reason_zh: '设备出口许可收紧 → 对华销售与高毛利服务收入回落 → AMAT/LRCX增长预期与估值倍数被压缩',
        family: 'chip-equipment-cycle',
        driver_type: 'policy',
        applies_to: 'symbols_only',
        symbols: ['AMAT', 'LRCX'],
    ...
    },
    {
        ...
        reason_zh: 'HBM供给分配与AI训练需求波动 → 产能切换、定价与产品组合反复调整 → MU营收节奏与估值溢价被重定价',
    ...
    },
    {
        ...
        reason_zh: '马斯克减持预期升温 → 流通盘抛压上升、短线风险偏好降温 → Tesla估值溢价快速回吐',
    ...
    },
    {
        ...
        reason_zh: '美联储激进加息推高实际利率 → 科技股折现率上升、风险偏好降温 → 高估值成长股估值倍数被压缩',
        family: 'rates',
        driver_type: 'macro',
        applies_to: 'us_tech',
    ...
    },
    {
        ...
        reason_zh: 'SVB危机冲击区域银行流动性预期 → 跨资产波动抬升、融资条件短线收紧 → 高贝塔科技股估值被快速下修',
    ...
    },
    {
        ...
        reason_zh: 'Tesla价格战延续、交付放缓 → 单车毛利率下滑、欧洲销量与库存周转走弱 → 收入增速和EPS预期被下修',
        family: 'tesla-demand',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['TSLA'],
    ...
    },
    {
        ...
        reason_zh: '欧洲品牌争议叠加中国价格战 → 注册量走弱、折扣扩大与交付放缓 → Tesla营收增速和利润率预期被下修',
        family: 'tesla-demand',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['TSLA'],
    ...
    },
    {
        ...
        reason_zh: '马斯克政治立场激化消费者抵制 → Tesla品牌价值、销量与EV份额同步走弱 → 收入增速和估值溢价被下修',
    ...
    },
    {
        ...
        reason_zh: '上海封控打断产线与物流 → Tesla产量、交付与库存周转同步受扰 → 中国收入与利润率预期被下修',
        family: 'tesla-demand',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['TSLA'],
    ...
    },
    {
        ...
        reason_zh: '流动性拐点叠加币价见顶回落 → 交易量与波动率降温、零售活跃度下滑 → COIN/HOOD收入与估值倍数被下修',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['COIN', 'HOOD'],
    ...
    },
    {
        ...
        reason_zh: 'Fed收紧流动性压制crypto风险偏好 → 币价、波动率与交易量同步下滑 → COIN/HOOD手续费收入与估值倍数被下修',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['COIN', 'HOOD'],
    ...
    },
    {
        ...
        reason_zh: 'Terra/LUNA崩盘触发加密信用去杠杆 → 币价急跌、交易量萎缩与对手风险抬升 → COIN/HOOD收入与盈利预期被下修',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['COIN', 'HOOD'],
    ...
    },
    {
        ...
        reason_zh: '币价反弹但市场波动率持续偏低 → 月度交易用户与手续费收入恢复偏慢 → COIN/HOOD盈利预期被下修',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['COIN', 'HOOD'],
    ...
    },
    {
        ...
        reason_zh: 'Silvergate/Signature危机冲击法币出入金 → USDC波动、资金通道受扰与成交降温 → COIN/HOOD收入预期短线下修',
    ...
    },
    {
        ...
        reason_zh: '山寨币轮动与监管噪音扰动交易结构 → 主流币成交降温、零售活跃度放缓 → COIN/HOOD手续费收入预期被下修',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['COIN', 'HOOD'],
    ...
    },
    {
        ...
        reason_zh: 'FTX暴雷引发加密信用危机扩散 → 币价、成交与对手风险同步恶化 → COIN/HOOD收入与估值倍数被下修',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['COIN', 'HOOD'],
    ...
    },
    {
        ...
        reason_zh: '比特币熊市叠加融资环境收紧 → 持币市值回落、融资压力抬升 → Strategy净资产溢价与估值倍数被下修',
        family: 'crypto-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['MSTR'],
    ...
    },
    {
        ...
        reason_zh: 'Terra/LUNA崩盘触发杠杆去化 → 比特币急跌、融资与流动性收缩 → Strategy净资产溢价与估值被重置',
        family: 'crypto-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['MSTR'],
    ...
    },
    {
        ...
        reason_zh: 'FTX暴雷放大加密信用风险 → 比特币下跌、融资压力与风险折价抬升 → Strategy估值溢价被快速压缩',
        family: 'crypto-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['MSTR'],
    ...
    },
    {
        ...
        reason_zh: '比特币熊市叠加融资环境收紧 → hashprice回落、成本率抬升与扩容放缓 → 矿企盈利与现金流预期被下修',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
    ...
    },
    {
        ...
        reason_zh: '现货ETF落地后仓位开始回吐 → 交易热度降温、零售成交放缓与费率承压 → COIN/HOOD收入增速与估值倍数被下修',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['COIN', 'HOOD'],
    ...
    },
    {
        ...
        reason_zh: 'Mt. Gox赔付预期叠加套息平仓 → 币价回调、交易活跃度降温与去杠杆加剧 → COIN/HOOD收入预期被下修',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['COIN', 'HOOD'],
    ...
    },
    {
        ...
        reason_zh: '选后加密仓位回吐、ETF分流加剧 → 零售成交降温、费率与交易量回落 → COIN/HOOD收入增速与估值弹性被下修',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['COIN', 'HOOD'],
    ...
    },
    {
        ...
        reason_zh: '交易量与波动率同步下行 → 零售活跃度回落、手续费收入收缩 → COIN/HOOD业绩预期与估值倍数被下修',
        family: 'crypto-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['COIN', 'HOOD'],
    ...
    },
    {
        ...
        reason_zh: '币价回调叠加ETF分流与稳定币监管 → 交易量降温、费率受压与零售参与放缓 → COIN/HOOD收入与估值倍数被下修',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['COIN', 'HOOD'],
    ...
    },
    {
        ...
        reason_zh: '地缘冲突升级打击风险偏好 → 比特币回调、成交降温与波动抬升 → COIN/HOOD收入预期短线被下修',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['COIN', 'HOOD'],
    ...
    },
    {
        ...
        reason_zh: '现货ETF落地重塑比特币持仓结构 → ETF资金流与融资预期放大MSTR高贝塔 → Strategy净资产溢价与估值区间被重估',
        family: 'crypto-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['MSTR'],
    ...
    },
    {
        ...
        reason_zh: '融资工具扩张叠加mNAV压缩 → 可转债/优先股摊薄预期升温、杠杆溢价回落 → Strategy估值倍数被下修',
        family: 'crypto-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['MSTR'],
    ...
    },
    {
        ...
        reason_zh: 'Mt. Gox赔付抬升比特币抛压担忧 → 币价回调与风险偏好降温放大杠杆波动 → Strategy估值溢价被压缩',
        family: 'crypto-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['MSTR'],
    ...
    },
    {
        ...
        reason_zh: 'Citron做空质疑MSTR相对比特币溢价 → mNAV压缩、交易拥挤度回落 → Strategy估值倍数被快速下修',
        family: 'crypto-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['MSTR'],
    ...
    },
    {
        ...
        reason_zh: '比特币回调叠加mNAV压缩 → 融资扩张预期降温、杠杆溢价回落 → Strategy估值倍数被持续下修',
        family: 'crypto-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['MSTR'],
    ...
    },
    {
        ...
        reason_zh: '减半下调区块奖励、算力竞争加剧 → hashprice回落、电力成本占比上升 → 矿企盈利弹性与估值倍数被下修',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['MARA', 'RIOT', 'CLSK'],
    ...
    },
    {
        ...
        reason_zh: '网络客户去库存、运营商与数通需求走弱 → 光模块出货与订单能见度下滑 → LITE/COHR/MRVL收入预期与估值倍数被下修',
    ...
    },
    {
        ...
        reason_zh: 'Alphabet云增速放缓、AI投入回收偏慢 → Cloud毛利率与订单能见度走弱 → 营收增速和估值弹性被下修',
    ...
    },
    {
        ...
        reason_zh: '郑州富士康停产叠加中国iPhone需求转弱 → 出货延迟、ASP与装机节奏受扰 → Apple营收与EPS预期被下调',
    ...
    },
    {
        ...
        reason_zh: 'DMA与DOJ反垄断挑战App Store规则 → 抽成率与默认入口收益承压 → Apple Services收入与估值溢价被下修',
    ...
    },
    {
        ...
        reason_zh: '华为Mate60回归叠加政府采购限制 → 中国iPhone销量与高端份额走弱 → Apple中国收入预期与估值溢价被下修',
    ...
    },
    {
        ...
        reason_zh: 'iPhone 17需求回暖叠加补贴刺激销量 → 中国市占率与换机节奏修复 → Apple中国收入预期与竞争折价被重估',
        family: 'aapl-china-competition',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['AAPL'],
    ...
    },
    {
        ...
        reason_zh: 'Azure增速放缓叠加PC周期下行 → Windows/Surface需求走弱、云订单增量放慢 → Microsoft营收增速与估值倍数被下修',
    ...
    },
    {
        ...
        reason_zh: 'FTC/CMA拖延动视暴雪审批 → 并购溢价与整合成本预期抬升 → Microsoft游戏业务回报与估值被下修',
    ...
    },
    {
        ...
        reason_zh: 'Copilot渗透慢于预期、Azure AI回报受质疑 → 席位扩张与云增长放缓 → Microsoft AI收入预期与估值溢价被下修',
    ...
    },
    {
        ...
        reason_zh: 'OpenAI合作裂痕与MAI-1替代预期升温 → Copilot产品路线与GPT依赖度受扰 → Microsoft AI溢价与收入预期被下修',
        family: 'msft-ai-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['MSFT'],
    ...
    },
    {
        ...
        reason_zh: '疫情后物流扩张过度、消费降速 → 履约成本抬升、零售利润率转负 → Amazon EPS与自由现金流预期被下修',
    ...
    },
    {
        ...
        reason_zh: '企业云支出优化与降本延续 → AWS工作负载增量放缓、单客扩容放慢 → Amazon云收入预期与估值溢价被下修',
    ...
    },
    {
        ...
        reason_zh: 'Azure/Google加码AI云竞争 → AWS资本开支抬升、自由现金流承压 → Amazon云业务估值溢价被重估',
        family: 'amzn-cloud-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['AMZN'],
    ...
    },
    {
        ...
        reason_zh: '智能手机与PC终端需求疲弱 → 晶圆利用率下滑、库存修正拖慢出货 → 台积电收入增速与估值倍数被下修',
        family: 'semiconductor-downcycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['TSM'],
    ...
    },
    {
        ...
        reason_zh: 'AI链条回调叠加贸易政策扰动 → 先进制程与封装订单节奏放缓 → 台积电营收预期与估值弹性被下修',
    ...
    },
    {
        ...
        reason_zh: 'Meta大幅加码AI资本开支 → 折旧与费用上升、广告利润率承压 → 自由现金流预期与估值弹性被下修',
    ...
    },
    {
        ...
        reason_zh: 'FTC投诉与参院调查升级 → 聊天机器人广告与未成年人保护成本上升 → Meta罚款风险与估值溢价被下修',
    ...
    },
    {
        ...
        reason_zh: 'Broadcom收购VMware叠加企业IT放缓 → 网络与软件订单走弱、整合成本抬升 → AVGO盈利预期与估值倍数被下修',
    ...
    },
    {
        ...
        reason_zh: 'AI回报争议与Blackwell延迟升温 → 云厂商算力采购节奏放缓、订单能见度走弱 → AI链条估值溢价被系统性压缩',
    ...
    },
    {
        ...
        reason_zh: 'DeepSeek低成本模型重估算力投入回报 → GPU、HBM与光互联订单预期降温 → AI链条收入预期与估值倍数被下修',
        family: 'ai-reset',
        driver_type: 'sector',
        applies_to: 'symbols_only',
    ...
    },
    {
        ...
        reason_zh: '宏观走弱叠加TikTok分流时长 → 搜索与YouTube广告单价及量级放缓 → Alphabet广告收入预期与估值被下修',
    ...
    },
    {
        ...
        reason_zh: 'Medicare Advantage成本超预期、指引撤回 → 医疗赔付率上升、利润率与现金流走弱 → UnitedHealth EPS与估值倍数被下修',
    ...
    },
    {
        ...
        reason_zh: '反垄断判决挑战苹果默认入口协议 → 搜索流量与TAC结构承压、AI Overviews变现受扰 → Alphabet搜索收入预期与估值溢价被下修',
    ...
    },
    {
        ...
        reason_zh: '反垄断罚款与Ant整改骤然落地 → 平台抽成、金融协同与商家规则受限 → 中概平台盈利预期与估值倍数被下修',
    ...
    },
    {
        ...
        reason_zh: '平台经济强监管持续升级 → 抽成率、数据使用与金融协同空间收缩 → 中概平台收入增速与估值倍数被下修',
        family: 'china-regulation',
        driver_type: 'policy',
    ...
    },
    {
        ...
        reason_zh: '封控余波与地产下行压弱中国增长 → 消费、广告与电商交易额走弱 → 中概平台收入预期与估值倍数被下修',
        family: 'china-growth',
        driver_type: 'macro',
        applies_to: 'china_tech',
    ...
    },
    {
        ...
        reason_zh: 'HFCAA与SEC观察名单升级 → 审计合规风险抬升、海外流动性折价扩大 → 中概平台估值倍数与融资预期被下修',
    ...
    },
    {
        ...
        reason_zh: '中美摩擦升级再度抬升ADR合规风险 → 审计与上市不确定性扩大、流动性折价上升 → 中概平台估值倍数被系统性下修',
        family: 'china-delisting',
        driver_type: 'policy',
        applies_to: 'symbols_only',
    ...
    },
    {
        ...
        reason_zh: '数据安全与Ant整改余波延续 → 平台流量变现与金融协同空间受限 → 中概平台盈利预期与估值倍数被下修',
        family: 'china-regulation',
        driver_type: 'policy',
        applies_to: 'symbols_only',
        symbols: ['BABA', 'JD', 'PDD', 'BIDU', 'NTES', 'TME', 'BILI', 'IQ', 'VIPS', 'TCEHY', 'BEKE'],
    ...
    },
    {
        ...
        reason_zh: '消费信心与地产链持续偏弱 → 电商GMV、广告投放与商家预算放缓 → 平台收入预期与估值倍数被下修',
        family: 'china-growth',
        driver_type: 'macro',
        applies_to: 'symbols_only',
    ...
    },
    {
        ...
        reason_zh: '价格战约束与商家治理规则重估 → 佣金率、补贴效率与GMV增长承压 → 平台盈利模式与估值倍数被下修',
    ...
    },
    {
        ...
        reason_zh: '广告预算偏弱、AI投入回收放慢 → 搜索变现与云业务利润率承压 → 百度收入预期与估值倍数被下修',
        family: 'china-platform-fundamental',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['BIDU'],
    ...
    },
    {
        ...
        reason_zh: '版号节奏与内容供给反复波动 → 新游流水与用户付费走弱 → 网易/腾讯游戏收入预期与估值倍数被下修',
        family: 'china-platform-fundamental',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['NTES', 'TCEHY'],
    ...
    },
    {
        ...
        reason_zh: '内容成本上升、广告变现偏弱 → 会员增长放缓与亏损改善节奏放慢 → BILI/IQ收入预期与估值倍数被下修',
        family: 'china-platform-fundamental',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['BILI', 'IQ'],
    ...
    },
    {
        ...
        reason_zh: '订阅增长放缓、社交娱乐热度回落 → ARPU与版权投入回收承压 → TME收入预期与估值倍数被下修',
        family: 'china-platform-fundamental',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['TME'],
    ...
    },
    {
        ...
        reason_zh: '房屋成交与地产信心持续走弱 → 经纪佣金与平台服务收入放缓 → BEKE营收预期与估值倍数被下修',
        family: 'china-platform-fundamental',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['BEKE'],
    ...
    },
    {
        ...
        reason_zh: '消费信心偏弱、品牌供给收缩 → 活跃用户与复购率放缓 → 唯品会收入预期与估值倍数被下修',
        family: 'china-platform-fundamental',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['VIPS'],
    ...
    },
    {
        ...
        reason_zh: 'Temu与国内电商竞争加剧、商家政策扰动 → 补贴率上升、佣金与GMV质量承压 → 拼多多收入增速与估值溢价被下修',
    ...
    },
    {
        ...
        reason_zh: 'de minimis取消叠加145%关税 → Temu美国用户、履约效率与GMV增速大幅回落 → PDD海外收入预期与估值倍数被下修',
    ...
    },
    {
        ...
        reason_zh: '利率路径与信贷成本预期变化 → NII、投行业务与拨备节奏反复波动 → 大型银行ROE与估值倍数被重定价',
    ...
    },
    {
        ...
        reason_zh: '油价与OPEC供给预期反复波动 → 上游realized price与炼化利润率回落 → 油气公司现金流与估值倍数被重估',
        family: 'oil-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
    ...
    },
    {
        ...
        reason_zh: '制造业PMI回落、经销商去库存延续 → 设备订单、backlog与利用率走弱 → 工业股收入预期与估值倍数被下修',
    ...
    },
    {
        ...
        reason_zh: 'AI订单节奏与回报预期降温 → 冷却与电力设备订单能见度下降 → Vertiv收入预期与估值倍数被下修',
        family: 'vrt-ai-infra',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['VRT'],
    ...
    },
    {
        ...
        reason_zh: '美国对等关税落地 → 跨境成本、风险偏好与全球需求预期同步恶化 → 风险资产盈利预期与估值倍数被下修',
        family: 'tariff',
        driver_type: 'policy',
        applies_to: 'us_tech',
    ...
    },
    {
        ...
        reason_zh: '关税预期升温压弱中国出口前景 → 外需、人民币与科技订单预期走弱 → 中国科技股盈利预期与估值倍数被下修',
        family: 'china-policy',
        driver_type: 'policy',
        applies_to: 'china_tech',
    ...
    },
    {
        ...
        reason_zh: '中美关税博弈升级 → 外需、汇率与风险溢价同步恶化 → 中国科技股收入预期与估值倍数被下修',
        family: 'china-policy',
        driver_type: 'policy',
        applies_to: 'china_tech',
    ...
    },
    {
        ...
        reason_zh: '云厂商质疑AI订单可持续性 → 数据中心电力与冷却订单节奏放缓 → Vertiv收入预期与估值倍数被下修',
        family: 'vrt-ai-infra',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['VRT'],
    ...
    },
    {
        ...
        reason_zh: 'Mag7创新高后AI回报预期降温 → 资本开支回收周期拉长、估值溢价回落 → 科技龙头估值倍数被阶段性压缩',
    ...
    },
    {
        ...
        reason_zh: '中东冲突推升油价与避险需求 → 利率、汇率与跨资产波动同步抬升 → 全球风险资产估值倍数被压缩',
        family: 'middle-east',
