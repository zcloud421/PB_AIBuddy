...
const NEWS_EVENT_SIGNAL_KEYWORDS: NewsEventSignalRule[] = [
    ...
    {
        tag: 'archegos-forced-deleveraging',
        keywords: ['archegos', 'forced selling', 'block trade', 'margin call', 'prime broker', 'trs', 'total return swap', 'leverage unwind', '强平', '杠杆清算', '被动抛售']
    }
];
...
const DRAWDOWN_ATTRIBUTION_RULES: AttributionMacroRule[] = [
    {
        ...
        reason_zh: 'ATT削弱广告定向叠加TikTok分流，Meta广告利润率承压',
    ...
    },
    {
        ...
        reason_zh: '利率上行推高SaaS折现率，企业软件估值与订阅预期回落',
    ...
    {
        id: 'archegos-cad-adr-blowup-2021',
        start: '2021-03-20',
        end: '2021-04-15',
        reason_zh: 'Archegos爆仓引发中概ADR集中强平，属流动性冲击非基本面因素',
        family: 'liquidity-event',
        driver_type: 'macro',
        applies_to: 'symbols_only',
        symbols: ['BIDU', 'TME', 'VIPS', 'IQ'],
        keywords: ['archegos', 'forced selling', 'block trade', 'margin call', 'total return swap', 'trs'],
        event_signal_tags: ['archegos-forced-deleveraging'],
        markers: ['Archegos', '强平', '流动性冲击', 'TRS', '中概ADR', '被动抛售']
    },
    {
        id: 'enterprise-software-ai-native-disruption-2023',
        start: '2023-03-01',
        end: '2026-12-31',
        reason_zh: '生成式AI分流单点工具需求，SaaS席位扩张预期降温',
        family: 'software-saas-cycle',
        driver_type: 'sector',
        applies_to: 'us_tech',
        archetypes: ['enterprise-software'],
    ...
    },
    {
        ...
        reason_zh: 'Figma收购告吹叠加AI设计分流，Adobe创意软件增长承压',
        family: 'software-saas-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['ADBE'],
    ...
    },
    {
        ...
        reason_zh: 'GLP-1竞争与产能节奏反复，LLY减肥药溢价被重估',
    ...
    },
    {
        ...
        reason_zh: '关税推高采购成本叠加中国份额流失，运动品牌毛利承压',
    ...
    },
    {
        ...
        reason_zh: 'Nike渠道修复偏慢且库存偏高，北美收入与EPS预期下调',
        family: 'consumer-discretionary-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['NKE'],
    ...
    },
    {
        ...
        reason_zh: 'Lululemon产品创新偏弱，美国同店与利润率预期降温',
        family: 'consumer-discretionary-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['LULU'],
    ...
    },
    {
        ...
        reason_zh: '加息压制IPO并购活动，高盛投行业务与ROE预期回落',
    ...
    },
    {
        ...
        reason_zh: '降息预期改善融资环境，投行收入与估值进入修复窗口',
        family: 'banking-credit-cycle',
        driver_type: 'macro',
        applies_to: 'all',
        archetypes: ['investment-bank-broker'],
    ...
    },
    {
        ...
        reason_zh: '高利率推升信用卡坏账压力，AXP利润与ROE预期承压',
        family: 'banking-credit-cycle',
        driver_type: 'macro',
        applies_to: 'symbols_only',
        symbols: ['AXP'],
    ...
    },
    {
        ...
        reason_zh: 'PC与消费电子需求转弱，AMD/INTC收入和利润预期下调',
    ...
    },
    {
        ...
        reason_zh: '挖矿退潮叠加PC走弱，NVIDIA游戏GPU收入预期回落',
        family: 'semiconductor-downcycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['NVDA'],
    ...
    },
    {
        ...
        reason_zh: 'DRAM/NAND供给过剩加剧，MU盈利与现金流预期承压',
    ...
    },
    {
        ...
        reason_zh: 'A100/H100对华限制落地，NVIDIA中国收入预期下调',
    ...
    },
    {
        ...
        reason_zh: 'H800/A800纳入限制，NVIDIA中国订单与AI溢价受压',
        family: 'chip-export-control',
        driver_type: 'policy',
        applies_to: 'symbols_only',
        symbols: ['NVDA', 'AMD'],
    ...
    },
    {
        ...
        reason_zh: 'BIS扩大实体清单，美系半导体对华业务预期下调',
        family: 'chip-export-control',
        driver_type: 'policy',
        applies_to: 'symbols_only',
    ...
    },
    {
        ...
        reason_zh: '先进芯片禁令升级，半导体龙头对华订单预期降温',
        family: 'chip-export-control',
        driver_type: 'policy',
        applies_to: 'symbols_only',
    ...
    },
    {
        ...
        reason_zh: '中国出货恢复附带合规成本，NVDA/AMD利润弹性被重估',
        family: 'chip-export-control',
        driver_type: 'policy',
        applies_to: 'symbols_only',
        symbols: ['NVDA', 'AMD'],
    ...
    },
    {
        ...
        reason_zh: '存储厂削减晶圆资本开支，AMAT/LRCX订单预期走弱',
    ...
    },
    {
        ...
        reason_zh: '设备出口许可收紧，AMAT/LRCX对华增长预期被压缩',
        family: 'chip-equipment-cycle',
        driver_type: 'policy',
        applies_to: 'symbols_only',
        symbols: ['AMAT', 'LRCX'],
    ...
    },
    {
        ...
        reason_zh: 'HBM需求与产能分配波动，MU营收节奏和溢价被重估',
    ...
    },
    {
        ...
        reason_zh: '马斯克减持预期升温，Tesla短线估值溢价回吐',
    ...
    },
    {
        ...
        reason_zh: '美联储激进加息推高实际利率，高估值成长股承压',
        family: 'rates',
        driver_type: 'macro',
        applies_to: 'us_tech',
    ...
    },
    {
        ...
        reason_zh: 'SVB危机冲击流动性预期，高贝塔科技股估值回落',
    ...
    },
    {
        ...
        reason_zh: 'Tesla价格战叠加交付放缓，毛利率和EPS预期承压',
        family: 'tesla-demand',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['TSLA'],
    ...
    },
    {
        ...
        reason_zh: '欧洲品牌争议叠加中国价格战，Tesla利润率预期下调',
        family: 'tesla-demand',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['TSLA'],
    ...
    },
    {
        ...
        reason_zh: '马斯克政治争议损害品牌，Tesla销量和估值溢价回落',
    ...
    },
    {
        ...
        reason_zh: '上海封控扰动产线物流，Tesla中国交付和利润率承压',
        family: 'tesla-demand',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['TSLA'],
    ...
    },
    {
        ...
        reason_zh: '币价见顶叠加流动性转弱，COIN/HOOD收入预期回落',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['COIN', 'HOOD'],
    ...
    },
    {
        ...
        reason_zh: 'Fed收紧压制crypto风险偏好，COIN/HOOD手续费预期下降',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['COIN', 'HOOD'],
    ...
    },
    {
        ...
        reason_zh: 'Terra/LUNA崩盘触发去杠杆，COIN/HOOD盈利预期下调',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['COIN', 'HOOD'],
    ...
    },
    {
        ...
        reason_zh: '币价反弹但波动率偏低，COIN/HOOD交易收入修复偏慢',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['COIN', 'HOOD'],
    ...
    },
    {
        ...
        reason_zh: 'Silvergate/Signature危机扰动资金通道，交易平台收入承压',
    ...
    },
    {
        ...
        reason_zh: '山寨币轮动叠加监管噪音，COIN/HOOD手续费预期降温',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['COIN', 'HOOD'],
    ...
    },
    {
        ...
        reason_zh: 'FTX暴雷引发信用危机，COIN/HOOD收入和估值承压',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['COIN', 'HOOD'],
    ...
    },
    {
        ...
        reason_zh: '比特币熊市叠加融资收紧，Strategy净资产溢价回落',
        family: 'crypto-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['MSTR'],
    ...
    },
    {
        ...
        reason_zh: 'Terra/LUNA冲击比特币流动性，Strategy溢价被重估',
        family: 'crypto-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['MSTR'],
    ...
    },
    {
        ...
        reason_zh: 'FTX暴雷放大信用风险，Strategy估值溢价快速收缩',
        family: 'crypto-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['MSTR'],
    ...
    },
    {
        ...
        reason_zh: '比特币熊市叠加融资收紧，矿企现金流预期承压',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
    ...
    },
    {
        ...
        reason_zh: '现货ETF落地后交易热度降温，COIN/HOOD收入增速放缓',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['COIN', 'HOOD'],
    ...
    },
    {
        ...
        reason_zh: 'Mt. Gox赔付预期压制币价，COIN/HOOD交易收入承压',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['COIN', 'HOOD'],
    ...
    },
    {
        ...
        reason_zh: '选后加密仓位回吐叠加ETF分流，平台收入弹性下降',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['COIN', 'HOOD'],
    ...
    },
    {
        ...
        reason_zh: '交易量与波动率同步下行，COIN/HOOD手续费收入收缩',
        family: 'crypto-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['COIN', 'HOOD'],
    ...
    },
    {
        ...
        reason_zh: '币价回调叠加监管压力，COIN/HOOD收入预期下修',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['COIN', 'HOOD'],
    ...
    },
    {
        ...
        reason_zh: '地缘冲突压制风险偏好，COIN/HOOD交易收入短线承压',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['COIN', 'HOOD'],
    ...
    },
    {
        ...
        reason_zh: '现货ETF重塑比特币资金流，Strategy高贝塔溢价波动放大',
        family: 'crypto-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['MSTR'],
    ...
    },
    {
        ...
        reason_zh: '融资扩张叠加mNAV压缩，Strategy杠杆溢价回落',
        family: 'crypto-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['MSTR'],
    ...
    },
    {
        ...
        reason_zh: 'Mt. Gox赔付抬升抛压担忧，Strategy估值溢价收缩',
        family: 'crypto-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['MSTR'],
    ...
    },
    {
        ...
        reason_zh: 'Citron质疑MSTR比特币溢价，Strategy拥挤交易回撤',
        family: 'crypto-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['MSTR'],
    ...
    },
    {
        ...
        reason_zh: '比特币回调叠加mNAV压缩，Strategy杠杆溢价下行',
        family: 'crypto-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['MSTR'],
    ...
    },
    {
        ...
        reason_zh: '比特币减半叠加算力竞争，矿企盈利弹性下降',
        family: 'crypto-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['MARA', 'RIOT', 'CLSK'],
    ...
    },
    {
        ...
        reason_zh: '网络客户去库存延续，光模块订单能见度下降',
    ...
    },
    {
        ...
        reason_zh: 'Alphabet云增速放缓，Cloud毛利和估值弹性承压',
    ...
    },
    {
        ...
        reason_zh: '郑州富士康停产叠加中国需求走弱，Apple营收预期下调',
    ...
    },
    {
        ...
        reason_zh: 'DMA与DOJ挑战App Store规则，Apple服务收入预期承压',
    ...
    },
    {
        ...
        reason_zh: '华为回归叠加采购限制，Apple中国高端份额承压',
    ...
    },
    {
        ...
        reason_zh: 'iPhone需求回暖叠加补贴，Apple中国收入折价收窄',
        family: 'aapl-china-competition',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['AAPL'],
    ...
    },
    {
        ...
        reason_zh: 'Azure增速放缓叠加PC下行，Microsoft营收预期降温',
    ...
    },
    {
        ...
        reason_zh: '动视暴雪审批拖延，Microsoft并购回报预期下调',
    ...
    },
    {
        ...
        reason_zh: 'Copilot渗透慢于预期，Microsoft AI收入溢价回落',
    ...
    },
    {
        ...
        reason_zh: 'OpenAI合作裂痕升温，Microsoft AI路线溢价受压',
        family: 'msft-ai-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['MSFT'],
    ...
    },
    {
        ...
        reason_zh: '疫情后物流扩张过度，Amazon零售利润率转负',
    ...
    },
    {
        ...
        reason_zh: '企业云支出优化延续，AWS收入增速预期放缓',
    ...
    },
    {
        ...
        reason_zh: 'AI云竞争推高AWS资本开支，Amazon自由现金流承压',
        family: 'amzn-cloud-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['AMZN'],
    ...
    },
    {
        ...
        reason_zh: '手机与PC需求疲弱，台积电利用率和收入预期下调',
        family: 'semiconductor-downcycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['TSM'],
    ...
    },
    {
        ...
        reason_zh: 'AI链条回调叠加贸易扰动，台积电订单预期降温',
    ...
    },
    {
        ...
        reason_zh: 'Meta大幅加码AI资本开支，自由现金流预期承压',
    ...
    {
        id: 'meta-ai-capex-sustained-2025-2026',
        start: '2025-04-01',
        end: '2026-06-30',
        reason_zh: 'Meta AI资本支出年度预算超千亿，市场反复定价回报验证节奏与自由现金流压缩风险',
        family: 'meta-ai-capex',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['META'],
        ...
        event_signal_tags: ['capex-reset', 'ai-capex-overhang'],
        markers: ['AI资本开支', '年度预算', '自由现金流', 'AI投入回报', 'CapEx指引', '数据中心']
    },
    {
        id: 'meta-court-liability-reset-2026',
        start: '2026-02-01',
        end: '2026-12-31',
        reason_zh: '法院判决Meta对未成年人成瘾设计承担赔偿责任，诉讼赔偿与合规成本快速定价',
        ...
        event_signal_tags: ['regulatory-probe', 'legal-liability'],
        markers: ['陪审团裁决', '未成年人成瘾', '赔偿责任', '法院败诉', '儿童安全诉讼']
    },
    {
        id: 'meta-regulatory-safety-reset-2025',
        start: '2025-11-01',
        end: '2026-01-31',
        reason_zh: 'FTC反垄断上诉叠加参院调查施压，Meta监管不确定性重新定价',
        family: 'meta-regulatory',
        driver_type: 'policy',
        applies_to: 'symbols_only',
        symbols: ['META'],
        ...
        event_signal_tags: ['regulatory-probe', 'antitrust-overhang'],
        markers: ['FTC反垄断', '参院调查', 'Instagram收购', '反垄断上诉', '监管施压']
    },
    {
        id: 'avgo-vmware-enterprise-reset-2022',
        start: '2022-01-01',
        end: '2024-06-30',
        reason_zh: 'VMware整合叠加企业IT放缓，AVGO盈利预期承压',
    ...
    },
    {
        ...
        reason_zh: 'AI回报争议叠加Blackwell延迟，AI链条溢价收缩',
    ...
    },
    {
        ...
        reason_zh: 'DeepSeek重估算力投入回报，AI硬件订单预期降温',
        family: 'ai-reset',
        driver_type: 'sector',
        applies_to: 'symbols_only',
    ...
    },
    {
        ...
        reason_zh: '宏观走弱叠加TikTok分流，Alphabet广告收入承压',
    ...
    },
    {
        ...
        reason_zh: 'Medicare成本超预期，UnitedHealth利润率和EPS预期下调',
    ...
    },
    {
        ...
        reason_zh: '反垄断挑战默认搜索协议，Alphabet搜索收入预期承压',
    ...
    },
    {
        ...
        reason_zh: '反垄断罚款叠加Ant整改，中概平台盈利预期下调',
    ...
    },
    {
        ...
        reason_zh: '平台经济强监管升级，中概平台收入增速预期降温',
        family: 'china-regulation',
        driver_type: 'policy',
    ...
    },
    {
        ...
        reason_zh: '封控余波叠加地产下行，中概平台收入预期承压',
        family: 'china-growth',
        driver_type: 'macro',
        applies_to: 'china_tech',
    ...
    },
    {
        ...
        reason_zh: 'HFCAA与SEC观察名单升级，中概ADR流动性折价扩大',
    ...
    },
    {
        ...
        reason_zh: '中美摩擦抬升ADR合规风险，中概流动性折价上升',
        family: 'china-delisting',
        driver_type: 'policy',
        applies_to: 'symbols_only',
        symbols: ['BABA', 'JD', 'PDD', 'BIDU', 'NTES', 'TME', 'BILI', 'IQ', 'VIPS', 'TCEHY', 'BEKE'],
    ...
    },
    {
        ...
        reason_zh: '数据安全监管叠加Ant整改，中概平台变现空间受限',
        family: 'china-regulation',
        driver_type: 'policy',
        applies_to: 'symbols_only',
        symbols: ['BABA', 'JD', 'PDD', 'BIDU', 'NTES', 'TME', 'BILI', 'IQ', 'VIPS', 'TCEHY', 'BEKE'],
    ...
    },
    {
        ...
        reason_zh: '消费信心与地产链偏弱，平台广告和GMV预期下调',
        family: 'china-growth',
        driver_type: 'macro',
        applies_to: 'symbols_only',
    ...
    },
    {
        ...
        reason_zh: '价格战约束叠加商家治理，平台盈利模式承压',
    ...
    {
        id: 'china-search-ai-hfcaa-2022',
        start: '2022-01-01',
        end: '2022-12-31',
        reason_zh: 'HFCAA退市风险叠加封控压广告，中概估值折价扩大',
        family: 'china-platform-policy',
        driver_type: 'policy',
        applies_to: 'symbols_only',
        symbols: ['BIDU'],
        archetypes: ['china-search-ai-platform'],
        subsectors: ['china-search-ai-platform'],
        cycle_families: ['china-platform-cycle'],
        keywords: ['hfcaa', 'sec list', 'delisting', 'audit inspections', 'lockdown', 'advertising revenue', 'online marketing'],
        event_signal_tags: ['hfcaa-delisting-risk', 'china-ad-spending-reset'],
        markers: ['HFCAA', 'SEC', '退市', '审计', '广告预算', '封控', '估值折价']
    },
    {
        ...
        subsectors: ['china-search-ai-platform'],
        cycle_families: ['china-platform-cycle'],
        keywords: ['ernie bot', 'chatgpt', 'demo', 'artificial intelligence', 'svb', 'risk appetite'],
        event_signal_tags: ['china-ad-spending-reset'],
    ...
    },
    {
        ...
        reason_zh: 'Temu竞争加剧叠加商家政策扰动，拼多多增长溢价回落',
    ...
    },
    {
        ...
        reason_zh: '利率路径与信贷成本反复，大型银行ROE预期波动',
    ...
    },
    {
        ...
        reason_zh: '油价与OPEC供给预期波动，油气公司现金流被重估',
        family: 'oil-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
    ...
    },
    {
        ...
        reason_zh: '制造业PMI回落叠加去库存，工业股订单预期走弱',
    ...
    },
    {
        ...
        reason_zh: 'AI订单回报预期降温，Vertiv设备订单能见度下降',
        family: 'vrt-ai-infra',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['VRT'],
    ...
    },
    {
        ...
        reason_zh: '美国对等关税落地，跨境成本和风险资产盈利承压',
        family: 'tariff',
        driver_type: 'policy',
        applies_to: 'us_tech',
    ...
    },
    {
        ...
        reason_zh: '关税预期升温压弱出口，中国科技股盈利预期下调',
        family: 'china-policy',
        driver_type: 'policy',
        applies_to: 'china_tech',
    ...
    },
    {
        ...
        reason_zh: '中美关税博弈升级，中国科技股风险溢价上升',
        family: 'china-policy',
        driver_type: 'policy',
        applies_to: 'china_tech',
    ...
    },
    {
        ...
        reason_zh: 'AI订单可持续性受质疑，Vertiv订单节奏预期降温',
        family: 'vrt-ai-infra',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['VRT'],
    ...
    },
    {
        ...
        reason_zh: 'Mag7新高后AI回报预期降温，科技龙头溢价回落',
    ...
    },
    {
        ...
        reason_zh: '中东冲突推升油价与避险需求，全球风险资产承压',
        family: 'middle-east',
    ...
    },
    {
        ...
        reason_zh: '疫情红利消退叠加共享泛滥，Netflix用户增长预期下调',
    ...
    },
    {
        ...
        reason_zh: '广告层定价偏低叠加整改不确定，Netflix ARPU预期承压',
        family: 'nflx-subscriber-cycle',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['NFLX'],
    ...
    },
    {
        ...
        reason_zh: '内容成本与体育版权竞价上升，Netflix利润弹性受限',
        family: 'nflx-subscriber-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['NFLX'],
    ...
    },
    {
        ...
        reason_zh: '比亚迪与特斯拉价格战，中国EV毛利率预期下调',
    ...
    },
    {
        ...
        reason_zh: '华为高端EV竞争加剧，理想/小鹏定价能力承压',
        family: 'china-ev-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['LI', 'XPEV', 'NIO'],
    ...
    },
    {
        ...
        reason_zh: '新能源补贴退坡后需求真空，中国EV销量预期波动',
        family: 'china-ev-cycle',
        driver_type: 'policy',
        applies_to: 'symbols_only',
        symbols: ['LI', 'XPEV', 'NIO'],
    ...
    },
    {
        ...
        reason_zh: '中美摩擦抬升中国EV上市风险，ADR流动性折价扩大',
        family: 'china-ev-cycle',
        driver_type: 'geopolitical',
        applies_to: 'symbols_only',
        symbols: ['LI', 'XPEV', 'NIO'],
    ...
    },
    {
        ...
        reason_zh: '美联储加息推高实际利率，黄金和矿商估值承压',
        family: 'gold-cycle',
        driver_type: 'macro',
        applies_to: 'all',
        archetypes: ['gold-etf', 'gold-miner'],
    ...
    },
    {
        ...
        reason_zh: '能源与劳工成本推高AISC，GDX矿商利润率承压',
        family: 'gold-cycle',
        driver_type: 'sector',
        applies_to: 'all',
    ...
    },
    {
        ...
        reason_zh: '银行危机缓和削弱避险需求，GLD/GDX涨幅回吐',
        family: 'gold-cycle',
        driver_type: 'macro',
        applies_to: 'all',
        archetypes: ['gold-etf', 'gold-miner'],
    ...
    },
    {
        ...
        reason_zh: '央行购金叠加避险推升金价，GLD/GDX高位回调压力上升',
        family: 'gold-cycle',
        driver_type: 'macro',
        applies_to: 'all',
        archetypes: ['gold-etf', 'gold-miner'],
    ...
    },
    {
        ...
        reason_zh: 'AMD Zen架构削弱Intel优势，服务器与PC份额承压',
    ...
    },
    {
        ...
        reason_zh: 'Intel 7nm制程延迟，技术溢价和长期竞争力预期下调',
        family: 'intc-competitive-reset',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['INTC'],
    ...
    },
    {
        ...
        reason_zh: 'Intel Foundry亏损扩大，代工战略可信度受损',
        family: 'intc-competitive-reset',
        driver_type: 'company',
        applies_to: 'symbols_only',
        symbols: ['INTC'],
    ...
    },
    {
        ...
        reason_zh: 'AI数据中心需求强但订单能见度不足，Arista溢价波动',
    ...
    },
    {
        ...
        reason_zh: '联邦预算收紧压制政府合同，Palantir收入预期承压',
    ...
    },
    {
        ...
        reason_zh: 'DOGE削减联邦开支，Palantir政府收入能见度下降',
        family: 'pltr-gov-cycle',
        driver_type: 'policy',
        applies_to: 'symbols_only',
        symbols: ['PLTR'],
    ...
    },
    {
        ...
        reason_zh: '数据库授权向云订阅转型偏慢，Oracle估值扩张受限',
    ...
    },
    {
        ...
        reason_zh: 'OCI算力订单激增但资本开支抬升，Oracle现金流承压',
        family: 'orcl-cloud-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['ORCL'],
    ...
    },
    {
        ...
        reason_zh: '跨境开户监管收紧，富途新增用户和收入预期下调',
    ...
    },
    {
        ...
        reason_zh: '港股与中概熊市压制交易活跃，富途EPS预期回落',
        family: 'futu-brokerage-cycle',
        driver_type: 'sector',
        applies_to: 'symbols_only',
        symbols: ['FUTU'],
    ...
    },
    {
        ...
        reason_zh: '加息通胀压缩可选消费，运动服饰收入预期承压',
        family: 'consumer-discretionary-cycle',
        driver_type: 'macro',
        applies_to: 'all',
        archetypes: ['consumer-brand'],
    ...
    },
    {
        ...
        reason_zh: 'OPEC+增产叠加需求放缓，XOM盈利和股息预期承压',
    ...
    },
    {
        ...
        reason_zh: '关税引发衰退担忧，金融股信贷损失预期上升',
        family: 'banking-credit-cycle',
        driver_type: 'policy',
        applies_to: 'all',
    ...
    },
    {
        ...
        reason_zh: '风险偏好收缩压低交易量，零售券商收入弹性下降',
    ...
    },
    {
        ...
        reason_zh: '加密熊市拖累数字资产交易量，券商盈利时间表延后',
        family: 'retail-brokerage-cycle',
        driver_type: 'sector',
        applies_to: 'all',
        archetypes: ['investment-bank-broker', 'crypto-exchange-broker'],
    ...
    },
    {
        ...
        reason_zh: 'PFOF与跨境开户受审查，经纪商估值折价扩大',
        family: 'retail-brokerage-cycle',
        driver_type: 'policy',
        applies_to: 'all',
        archetypes: ['investment-bank-broker', 'crypto-exchange-broker'],
    ...
    },
    {
        ...
        reason_zh: 'AI推理效率提升削弱电力需求叙事，电力设备估值回落',
    ...
    },
    {
        ...
        reason_zh: 'IRA补贴审查收紧，清洁能源项目回报率被重估',
        family: 'power-ai-demand',
        driver_type: 'policy',
        applies_to: 'all',
        archetypes: ['power-utility', 'industrial-machinery', 'diversified-industrial'],
    ...
    },
    {
        ...
        reason_zh: '激进加息推高项目融资成本，电力公用事业估值承压',
        family: 'power-ai-demand',
        driver_type: 'macro',
        applies_to: 'all',
        archetypes: ['power-utility', 'industrial-machinery', 'diversified-industrial'],
    ...
    },
    {
        ...
        reason_zh: '版号审批与未成年限制收紧，游戏平台收入预期下调',
    ...
    },
    {
        ...
        reason_zh: '短视频分流用户时长和广告预算，内容平台成长溢价回落',
        family: 'china-gaming-regulation',
        driver_type: 'sector',
        applies_to: 'china_tech',
        archetypes: ['china-online-gaming', 'china-content-platform'],
    ...
    },
    {
        ...
        reason_zh: '消费信心疲软叠加青年失业，内容平台ARPU增长乏力',
        family: 'china-gaming-regulation',
        driver_type: 'macro',
        applies_to: 'china_tech',
        archetypes: ['china-online-gaming', 'china-content-platform'],
    ...
    },
    {
        ...
        reason_zh: '手机出货下行叠加5G透支，移动芯片订单预期下降',
    ...
    },
    {
        ...
        reason_zh: '云厂商自研AI芯片加速，第三方芯片收入能见度下降',
        family: 'mobile-semi-cycle',
        driver_type: 'sector',
        applies_to: 'us_tech',
    ...
    },
    {
        ...
        reason_zh: 'BIS限制先进设备对华销售，设备商中国收入预期下调',
    ...
    },
    {
        ...
        reason_zh: 'DRAM/NAND下行压缩设备开支，WFE新订单预期下降',
        family: 'semcap-export-control',
        driver_type: 'sector',
        applies_to: 'us_tech',
        archetypes: ['chip-equipment'],
...
function getActiveAttributionRulesForSymbol(
    symbol: string,
    today: string
): Array<{ id: string; reason_zh: string; driver_type: string; family: string }> {
    const symbolArchetypes = SYMBOL_ARCHETYPE_MAP
        .filter((entry) => entry.symbols.includes(symbol))
        .map((entry) => entry.archetype);

    const symbolCycleFamilies = SYMBOL_CYCLE_FAMILY_MAP
        .filter((entry) => entry.symbols.includes(symbol))
        .map((entry) => entry.cycle_family);

    const driverPriority: Record<string, number> = {
        policy: 0,
        geopolitical: 1,
        macro: 2,
        mixed: 3,
    ...
    return DRAWDOWN_ATTRIBUTION_RULES
        .filter((rule) => {
            ...
            if (rule.symbols && rule.symbols.includes(symbol)) {
                return true;
            }
            ...
            if (rule.applies_to === 'us_tech' && US_TECH_ATTRIBUTION_SYMBOLS.has(symbol)) {
                return true;
            }
            if (rule.applies_to === 'china_tech' && CHINA_TECH_ATTRIBUTION_SYMBOLS.has(symbol)) {
                return true;
            }

            if (rule.archetypes && rule.archetypes.some((a) => symbolArchetypes.includes(a as AttributionBusinessArchetype))) {
                return true;
            }

            if (rule.cycle_families && rule.cycle_families.some((f) => symbolCycleFamilies.includes(f as AttributionCycleFamily))) {
                return true;
            }
        ...
        .sort((left, right) => {
            const leftExact = left.symbols?.includes(symbol) ? 0 : 1;
            const rightExact = right.symbols?.includes(symbol) ? 0 : 1;
            if (leftExact !== rightExact) {
                return leftExact - rightExact;
            }

            const leftPriority = driverPriority[left.driver_type] ?? 99;
            const rightPriority = driverPriority[right.driver_type] ?? 99;
...
function buildNarrativePriceMomentumFromHistory(
    history: Array<{ date: string; close: number }>,
    currentPrice: number | null
): NarrativePriceMomentum {
    return {
        change1dPct: calculateNarrativePctChange(history, currentPrice, 1),
        change5dPct: calculateNarrativePctChange(history, currentPrice, 5),
        changeYtdPct: calculateNarrativeYtdChange(history, currentPrice)
    };
}
...
export async function getSymbolIdea(symbol: string): Promise<SymbolIdeaResponse | AsyncScoringAcceptedResponse> {
    ...
    if (cachedRow) {
        ...
        const needsNarrativeRefresh =
            ...
            Boolean(stalePitchNarrativeReason);
        if (needsNarrativeRefresh) {
            if (stalePitchNarrativeReason && !hasOtherNarrativeRefreshReason) {
                console.log(
                    JSON.stringify({
                        tag: 'pitch_engine_force_refresh',
                        symbol: cachedRow.symbol,
                        grade: cachedRow.overall_grade,
                        reason: stalePitchNarrativeReason,
                        source_quality: cachedRow.source_quality,
                        pitch_engine_version: PITCH_ENGINE_VERSION,
                        ts: new Date().toISOString()
                    })
                );
            }
            void refreshNarrativeInBackground(
                normalizedSymbol,
                cachedRow,
                priceContext,
                effectiveFlags,
...
async function refreshNarrativeInBackground(
    ...
    const effectiveCurrentPrice = toNullableNumber(priceContext?.current_price ?? cachedRow.current_price);
    const priceHistory = await getRecentPriceHistoryBySymbol(symbol, 260).catch(() => []);
    const priceMomentum = buildNarrativePriceMomentumFromHistory(priceHistory, effectiveCurrentPrice);
    const today = new Date().toISOString().split('T')[0];
    const activeAttributionRules = getActiveAttributionRulesForSymbol(symbol, today);
    const narrative = await buildNarrative({
        symbol,
        companyName: underlying?.company_name ?? getCompanyName(symbol),
        theme: underlying?.themes?.[0] ?? 'Featured',
...
1. 禁止使用以下表达,任一出现都会被系统自动拒绝:
   - "板块轮动" / "情绪切换" / "市场担忧" / "估值压力"
   - "新闻缺乏明确事件" / "未发现具体催化" / "缺乏明确事件"
   - "跑输同业 X%" / "跑赢同业 X%"(这只是描述结果,不是原因)
   - "现金流重估" / "盈利预期下调"(没具体来源不能用)
   - "宏观不确定性" / "短期波动加大"(空泛)

2. 必须包含具体事件锚点(任一)
   - 事件日期 + 具体决议/数据(例:"OPEC+ 2022-06-02 决议 7 月日增产 64.8 万桶")
   - 央行 / 政策 / 监管动作 + 具体内容
   - 公司财报 + 具体数据(EPS / 营收 / 指引偏离)
   - 行业基本面拐点 + 量化指标(库存 / 价格 / 销量同比)

3. 正确示例 vs 错误示例:

❌ "油价波动叠加板块轮动,XOM 跑输同业 14%,新闻缺乏明确事件"
✅ "俄乌战争 2022-02-24 爆发,Brent 油价单日 +6.6% 至 99 美元,
   能源股短期普涨后高位回调,XOM 三周回撤 14%"

❌ "OPEC 供给预期波动,XOM 现金流重估,跑输同业 23.7%"
✅ "OPEC+ 6 月 2 日决议日增产 64.8 万桶(预期 43 万),
   叠加美国战略储备投放,WTI 当周 -4.7%,XOM 跟跌 23.7%"

4. 如果新闻输入里真的没有具体事件,output 留空,不要硬编。
   系统宁可空也不要废话。
...
async function mapDailyBestCard(
    ...
    const themeNarrative = buildThemeNarrative(idea.themes ?? [theme], flagsBySymbol.get(symbol) ?? []);
    const narrative = idea.why_now
        ...
        : await (async () => {
              ...
              const missingFields = [
                  currentPrice !== null && currentPrice > 0 ? null : 'current_price',
                  recommendedStrike > 0 ? null : 'recommended_strike'
              ].filter((field): field is string => Boolean(field));

              if (missingFields.length > 0) {
                  console.log(JSON.stringify({
                      tag: 'daily_best_narrative_skipped',
                      symbol,
              ...
              const [newsContext, priceHistory, recentEarnings] = await Promise.all([
                  fetchStockNewsContext(symbol, idea.company_name ?? undefined),
                  getRecentPriceHistoryBySymbol(symbol, 260).catch(() => []),
                  getRecentEarningsBySymbol(symbol).catch(() => null)
              ]);
              const priceMomentum = buildNarrativePriceMomentumFromHistory(priceHistory, currentPrice);

              return buildNarrative({
                  newsItems: newsContext.narrativeItems,
                  hasRecentEarnings: newsContext.hasRecentEarnings,
                  earningsWeight: newsContext.earningsWeight,
                  daysSinceEarnings: newsContext.daysSinceEarnings ?? recentEarnings?.days_since ?? null,
                  symbol,
                  ...
                  change5dPct: priceMomentum.change5dPct,
                  changeYtdPct: priceMomentum.changeYtdPct,
                  pctFrom52wHigh: parseNullableNumber(idea.pct_from_52w_high ?? null),
                  ma20: parseNullableNumber(idea.ma20 ?? null),
                  ma50: parseNullableNumber(idea.ma50 ?? null),
                  ma200: parseNullableNumber(idea.ma200 ?? null),
